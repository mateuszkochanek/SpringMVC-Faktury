...
public class AppController {
  ...
  // Field saves subjects during invoice creation
  ...
  public String showInvoicePage(@RequestParam("customerId") int theCustomerId,
      @RequestParam("invoiceId") int theInvoiceId, Model theModel) {

    Invoice invoice = invoiceDAO.getInvoice(theInvoiceId);
    theModel.addAttribute("invoice", invoice);
    theModel.addAttribute("customer", customerDAO.getCustomer(theCustomerId));
    theModel.addAttribute("sumPrice", invoice.getSumPrice());
    return "show-invoice";
  }
  ...
  public String saveInvoiceSubject(@ModelAttribute("subject") InvoiceSubject theInvoiceSubject,
